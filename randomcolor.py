"""
From:
    https://github.com/kevinwuhoo/randomcolor-py.git
"""
import colorsys
import random
import json
...
class RandomColor(object):
    def __init__(self, seed=None):
        ...
        for color_name, color_attrs in list(colormap.items()):
            ...
            colormap[color_name]['saturation_range'] = [sMin, sMax]
            colormap[color_name]['brightness_range'] = [bMin, bMax]
    ...
    def pick_brightness(self, H, S, luminosity):
        ...
        return self.random_within([int(bMin), int(bMax)])
    ...
    def get_hue_range(self, color_input):
        ...
        elif color_input and color_input in colormap:
                color = colormap[color_input]
    ...
    def get_color_info(self, hue):
        ...
        for color_name, color in list(colormap.items()):
